      ...
      return (
        <React.Fragment>
          <ModalBody>   
            ...
            <p className="passion-one-font">I understand that continuing with this action will remove all of my personally identifiable profile, game, and player data forever.</p>   
            <Form 
