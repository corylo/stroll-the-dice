    ...
    try {
      ...
      await db.runTransaction(async (transaction: firebase.firestore.Transaction) => {
        ...
        if(gameDoc.exists) {
          ...
          GameEventTransactionService.create(transaction, game.id, GameEventUtility.mapPlayerCreatedEvent(FirestoreDateUtility.addMillis(game.createdAt, 1), player.id));
